                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        const AppBackButton(),
                        const Text('Metas', style: AppTextStyles.headlineLarge),
                      ],
                    ),
                  ),
                ),
                      ...
                      child: Row(
                        children: [
                          _FilterChip(
                            label: 'Tudo',
                            isSelected:
                                state.activeFilter == MissionCategory.all,
                            onTap: () => context
                                .read<MissionsCubit>()
                                .filterMissions(MissionCategory.all),
                          ),
                          const SizedBox(width: 8),
                          _FilterChip(
                            label: 'Aprendizado',
                            isSelected:
                                state.activeFilter == MissionCategory.learning,
                            onTap: () => context
                                .read<MissionsCubit>()
                                .filterMissions(MissionCategory.learning),
                          ),
                          const SizedBox(width: 8),
                          _FilterChip(
                            label: 'Prática',
                            isSelected:
                                state.activeFilter == MissionCategory.practice,
                            onTap: () => context
                                .read<MissionsCubit>()
                                .filterMissions(MissionCategory.practice),
                          ),
                        ],
                      ),
                    ),
                      ...
                      : SliverGrid(
                          gridDelegate:
                              const SliverGridDelegateWithFixedCrossAxisCount(
                                ...
                                mainAxisSpacing: 12,
                                childAspectRatio:
                                    0.9, // Ajustado para suportar a barra de progresso sem quebrar o layout
                              ),
                          delegate: SliverChildBuilderDelegate(
                            (context, i) =>
                                MissionCard(mission: state.filteredMissions[i]),
