  ...
  Future<List<Map<String, dynamic>>> getNews() async {
    ...
    return [
      ...
      },
      {
        'id': '8',
        'title':
            'Assembleia da Venezuela dá aval inicial a investimento privado no setor elétrico',
        'content':
